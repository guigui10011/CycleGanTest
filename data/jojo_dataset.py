...
class JojoDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.B_paths = sorted(make_dataset(self.dir_B, opt.max_dataset_size))    # load images from '/path/to/data/trainB'   # cene
        ...
        self.transform_B = get_transform(self.opt, grayscale=(output_nc == 1), A=True)
